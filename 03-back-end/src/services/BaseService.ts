...
export default abstract class BaseService<ReturnModel extends IModel> {
    ...
    public async getByIdFromTable(tableName: string, id: number): Promise<ReturnModel|null|IErrorResponse>{
     ...
     protected async getAllByFieldName(tableName:string, fieldName:string, fieldValue: any): Promise<ReturnModel[]|IErrorResponse>{
        return new Promise<ReturnModel[]|IErrorResponse>(async(resolve) =>{
