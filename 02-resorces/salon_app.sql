...
-- Dumping data for table salon_app.admin: ~0 rows (approximately)
...
-- Dumping data for table salon_app.location: ~0 rows (approximately)
...
-- Dumping data for table salon_app.service: ~0 rows (approximately)
